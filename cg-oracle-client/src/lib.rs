...
impl Oracle for CGOracleClient {
...
mod tests {
    ...
    fn get_public_key_test() {
        ...
        let client = CGOracleClient::new(url).expect("Error creating client instance.");
